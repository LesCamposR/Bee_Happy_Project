...
import Arte1 from "../../img/Arte1.png";
import Arte2 from "../../img/Arte2.png";
...
const products = [
  {
    ...
    message: "Gracias por adquirir nuestros productos. Esperamos que tu experiencia con nosotros sea extraordinaria",
    price: 6000,
    weight: 1000,
    image: Bottle2,
    imageArt: Arte1,
  },
  {
    ...
    title: "Jarra Mediana",
    text: "100% natural, localmente producida, de gran textura, aroma y color, con una amplia diversidad nutritiva.",
    message: "Gracias a ti, estamos creciendo más allá de nuestras expectativas.",
    price: 4500,
    weight: 458,
    image: Medium,
    imageArt: Arte2,
  },
  {
    ...
    title: "Jarra Pequena",
    text: "100% natural, localmente producida, de gran textura, aroma y color, con una amplia diversidad nutritiva.",
    message: "Clientes como tú hacen la diferencia. Es un placer atenderte.",
    price: 3500,
    weight: 265,
    image: Small,
    imageArt: Arte3,
        ...
        <>
          ...
          <div className="h-100 bg-light">
            <div className="row">
              ...
              <div className="col-3 bg-light justify-content-center mt-4 p-4">
                <img width="80%" src={prod.imageArt} alt="Arte" />
              </div>
            </div>
          </div>
        </>
